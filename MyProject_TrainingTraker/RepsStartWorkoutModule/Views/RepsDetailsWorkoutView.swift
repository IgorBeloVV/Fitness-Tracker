...
class RepsDetailsWorkoutView: UIView {
    
    weak var cellNextSetDelegate: NextSetProtocol?
    
    private let exerciseNameLabel = UILabel(text: "Biceps", font: .robotoMedium24(), textColor: .specialGray)
    ...
    private let repsCountLabel = UILabel(text: "20", font: .robotoMedium24(), textColor: .specialGray)
    
    private lazy var repsStackView = UIStackView(arrangedSubviews: [repsLabel,
                                                                    repsCountLabel],
                                                 axis: .horizontal,
                                                 spacing: 10)
    ...
    func refreshLabels(_ model: WorkoutModel, numberOfSet: Int) {
        ...
        repsCountLabel.text = "\(model.workoutReps)"
    }
}

//MARK: - Set Constraints

extension RepsDetailsWorkoutView {
